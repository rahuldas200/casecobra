    ...
    <div className="relative mt-20 grid grid-col-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      <div className="h-[37.5rem]  w-full col-span-full lg:col-span-1  flex  flex-col bg-white">
                    ...
                    <DropdownMenuContent>
                      {MODELS.options.map((model) => (
                        <DropdownMenuItem
                          key={model.label}
                          className={cn(
                            "flex text-sm gap-3 items-center p-1.5 cursor-default hover:bg-zing-100",
                            {
                              "bg-zinc-100":
                      ...
                      <div className="mt-3 space-y-3">
                        {selectableOption.map((option) => (
                          ...
                          >
                            ...
                            <RadioGroup.Description
                              as="span"
                              className="mt-2 flex text-sm sm:ml-5 sm:mt-0 sm:flex-col sm:text-right"
                            >
        ...
        <div className="w-full px-8 h-16 bg-white">
          <div className="g-px w-full bg-zinc-200" />
